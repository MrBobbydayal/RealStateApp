...
return(
    <div> 
        <div className="flex justify-between px-20 p-4 shadow-lg bg-blue-400">
            ...
            <div className="flex gap-4 items-center "><div><img alt="logo" src={logo} className="h-14 rounded-full"/></div> <div className="font-semibold text-3xl text-white ">StayFinder </div></div>
